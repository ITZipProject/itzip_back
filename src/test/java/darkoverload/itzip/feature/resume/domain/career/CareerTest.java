...
class CareerTest {
    ...
    void 경력_업데이트_정적_메소드_성공_테스트() {
        ...
        Resume resume = Resume.builder().profileInfo(profileInfo).links(List.of("https://itzip.com")).userId(1L).resumeId(1L).build();
        ...
        assertThat(career).isEqualTo(new Career(Resume.builder().profileInfo(profileInfo).links(List.of("https://itzip.com")).userId(1L).resumeId(1L).build(), "잇집회사", "사원", "개발팀", LocalDateTime.of(2022,6,10,0,0), LocalDateTime.of(2023,6,10,0,0), 1L));
    }

    @Test
    void 아이디_이력서_동일_true_테스트() {
        Career career = Career.update(new CareerDto("잇집회사", "사원", "개발팀", LocalDateTime.of(2022,6,10,0,0), LocalDateTime.of(2023,6,10,0,0), 1L), Resume.builder().profileInfo(profileInfo).links(List.of("https://itzip.com")).userId(1L).resumeId(1L).build());
