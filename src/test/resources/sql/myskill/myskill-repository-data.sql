...
insert into my_skills (id, create_date, modify_date, name, resume_id)
values (1L, '2024-09-26 10:00:05', '2024-09-26 10:00:05', 'Java', 1L);

insert into my_skills (id, create_date, modify_date, name, resume_id)
values (2L, '2024-11-26 10:00:05', '2024-11-26 10:00:05', 'PostgreSQL', 1L);