...
public class JobInfoScheduler {
    ...
    public void jobInfoConnectApi() {
        ...
        JobInfos dbJobInfos = new JobInfos(jobInfoRepository.findAll().stream().toList());
