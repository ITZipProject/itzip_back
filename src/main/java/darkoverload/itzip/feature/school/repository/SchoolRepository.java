...
import darkoverload.itzip.feature.school.repository.custom.CustomSchoolRepository;
...
public interface SchoolRepository extends ElasticsearchRepository<SchoolDocument, Long>, CustomSchoolRepository {
   long count();
