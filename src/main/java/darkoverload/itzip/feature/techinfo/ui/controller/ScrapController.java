...
@Tag(
        ...
        description = "스크랩 등록, 취소 기능을 제공하는 API"
)
@RestController
...
public class ScrapController {
    ...
    private final ScrapCommandService commandService;

    @Operation(
            summary = "스크랩 등록",
            description = "로그인한 사용자가 특정 아티클에 대해 스크랩을 등록합니다.",
    ...
    @ExceptionCodeAnnotations({
            ...
            CommonExceptionCode.ALREADY_SCRAP_ARTICLE
    })
    ...
    public ResponseEntity<String> register(
        ...
        return ResponseEntity.ok("스크랩이 성공적으로 등록되었습니다.");
    }

    @Operation(
            summary = "스크랩 취소",
            description = "로그인한 사용자가 특정 아티클에 대해 스크랩을 취소합니다.",
            security = @SecurityRequirement(name = "bearerAuth")
    )
    @ExceptionCodeAnnotations({
            CommonExceptionCode.UNAUTHORIZED,
    ...
    @DeleteMapping("/scrap/{article_id}")
    public ResponseEntity<String> cancel(
        ...
        return ResponseEntity.ok("스크랩이 성공적으로 취소되었습니다.");
    }
